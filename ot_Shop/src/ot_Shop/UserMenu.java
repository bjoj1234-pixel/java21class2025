...
public class UserMenu extends User {
	...
	public int userLog() {
		...
		if(log < 0) {
			...
			logindex = log; //다른 클래스에서 사용하기 위해 static으로 로그인 정보를 저장
		}
		return log;//logindex를 넣어도되나, static보다는 일반변수를 넣는게 정석
	}
