...
public class String_Example01 {
	...
	public static void main(String[] args) {
		...
		if(a==b) {
			//a와b는 문자의 데이터값은 같아도 서로다른 참조 주소이므로 같지 않다.
		...
		//문자열 리터럴 이용하여 작성
		//문자열 리터럴 이용하여 작성하면 String pool에 저장됨을 주의하자
		//같은 문자열 리터럴이 이미 존재하면 새로 만들지 않고 기존 객체를 재사용한다.
		//참조 주소가 같기때문에 ==연산자를 이용해 비교해도 true가 출력된다.
		...
		//String pool를 사용하지않고, 새로운 String 객체를 Heap에 생성한다.
