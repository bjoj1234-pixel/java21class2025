...
public class DataEx01 {
	...
	public static void main(String[] args) {
		...
		// Integer => 객체 데이터 타입
		// 객체 타입의 변수에 저장되는 값은 실제값이 존재하는 메모리의 번지주소이다.
		// 현재 str변수에 저장된 데이터는 "Abort"가 아니라
		// "Abort"가 존재하는 메모리 어드레스 주소인 2ff4acd0 이다.
		String str ="Abort";
		System.out.println(System.identityHashCode(str)); //메모리 번지주소
		int id = System.identityHashCode(str); //804564176
		System.out.println(Integer.toHexString(id)); //2ff4acd0
		System.out.println(str);
		
		// 이스케이프 형식을 이용해서 문자안의 각종 특정 문자를 포함 시킬수있다.
		...
		//반드시 L 또는 l 접미사를 붙인다.
		//long lo1 = 100000000000000000; <- L을 안붙이면 오류
